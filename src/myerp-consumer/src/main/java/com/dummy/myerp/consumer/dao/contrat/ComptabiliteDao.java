...
public interface ComptabiliteDao {
   ...
   Integer getDerniereSequence(int annee, String codej);
    
    void insertSequenceEcritureComptable(SequenceEcritureComptable seq, String codej);
    
    void updateSequenceEcritureComptable(SequenceEcritureComptable seq, String codej);
}
