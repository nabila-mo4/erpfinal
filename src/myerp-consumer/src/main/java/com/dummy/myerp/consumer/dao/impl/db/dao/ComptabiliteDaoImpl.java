...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    public Integer getDerniereSequence(int annee, String codej) {
    	...
    	SequenceEcritureComptableRM seqRM = new SequenceEcritureComptableRM();
    	
    	try {
    		int dvaleur = vJdbcTemplate.queryForObject(SQLgetDerniereSequenceEcritureComptable,vSqlParams, seqRM).getDerniereValeur();
        	return dvaleur;
    	}
    ...
    public void insertSequenceEcritureComptable(SequenceEcritureComptable seq, String codej) {
    	NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        vSqlParams.addValue("journal_code", codej);
        vSqlParams.addValue("annee", seq.getAnnee());
        vSqlParams.addValue("derniere_valeur", seq.getDerniereValeur());
    ...
    public void updateSequenceEcritureComptable(SequenceEcritureComptable seq, String codej) {
    	NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        vSqlParams.addValue("journal_code", codej);
        vSqlParams.addValue("annee", seq.getAnnee());
